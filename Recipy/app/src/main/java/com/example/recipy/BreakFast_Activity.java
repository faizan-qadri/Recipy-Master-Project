...
public class BreakFast_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cat_list = findViewById(R.id.breakfastList);
        firestore = FirebaseFirestore.getInstance();

        Toolbar toolbar = findViewById(R.id.breakfastToolbar);
        ...
        firestore.collection("Breakfast_Data").orderBy("index", Query.Direction.DESCENDING).addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
            public void onEvent(@Nullable QuerySnapshot value, @Nullable FirebaseFirestoreException error) {
                if (error != null){
                    Toast.makeText(BreakFast_Activity.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                }
